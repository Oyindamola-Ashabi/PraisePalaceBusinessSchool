...
const TermsandCondition = () => {
  ...
  const sections = [
    ...
    { id: 'purpose', title: '2. Purpose & Scope', content: <p>These Terms and Conditions govern your access to and use of our website, enrollment in programs, participation in events, mentorship services, and any other offerings provided by PraisePalace Business School.</p> },
    ...
    { id: 'acceptance', title: '4. Acceptance of Terms', content: <p>By registering, enrolling, attending, or accessing any of our services, you confirm that you have read, understood, and agree to these Terms and Conditions, along with our Privacy Policy.</p> },
    { id: 'services', title: '5. Our Services', content: <p>We provide business education, training programs, mentorship, workshops, summits, and related events. Services are subject to availability, and we reserve the right to modify, suspend, or discontinue any service at any time without prior notice.</p> },
    ...
    { id: 'fees', title: '7. Fees & Billing', content: <p>Fees for programs and events are listed at the time of registration. All payments are processed securely. Fees are non-refundable unless otherwise stated in the specific program/event terms.</p> },
    { id: 'data-protection', title: '8. Data Protection & Privacy', content: <p>Your personal data is handled in accordance with our Privacy Policy. We comply with applicable data protection laws to ensure your information is secure and used only for legitimate purposes.</p> },
    { id: 'confidentiality', title: '9. Confidentiality', content: <p>Participants agree to keep confidential any proprietary or sensitive information shared during programs, mentorship sessions, or events, including business ideas, strategies, and personal details of others.</p> },
    ...
    { id: 'certificate', title: '13. Certificate & Accreditation', content: <p>Certificates are issued only upon successful completion of a program. They reflect participation and/or achievement as defined by the program. PraisePalace Business School certificates are not nationally accredited degrees unless explicitly stated.</p> },
    ...
    { id: 'liability', title: '16. Limitation of Liability', content: <p>To the fullest extent permitted by law, PraisePalace Business School shall not be liable for indirect, incidental, or consequential damages arising from use of our services.</p> },
    { id: 'termination', title: '17. Termination of Access', content: <p>We reserve the right to suspend or terminate your access to any service for violation of these terms, disruptive behavior, or at our sole discretion.</p> },
    ...
    { id: 'governing-law', title: '19. Governing Law', content: <p>These Terms are governed by the laws of England and Wales. Any disputes shall be resolved exclusively in the courts of England.</p> }
  ];
